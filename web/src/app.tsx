      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            ...
            />
            <Textarea value={completion} placeholder="Resultado gerado pela IA..." className="resize-none p-4 leading-relaxed" readOnly />
          </div>
        ...
        <aside className="w-80 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6" action="">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic">Você poderá utilizar essa opção em breve</span>
            </div>
            <Separator />
